...
start cmd.exe /C "C:\Qt\6.9.0\mingw_64\bin\qtenv2.bat & cd /d C:\Documents\Coding_Projects\GitHub\ChessQt\build\Desktop_Qt_6_9_0_MinGW_64_bit-MinSizeRel & start ChessQt.exe --client"
